# fixed App.register_component_ in leapmmw_sensor.yml
...
### Installation:
 * Download the [leapmmw_sensor.h](https://raw.githubusercontent.com/Presswerk65/esphome-hs2xx3a-custom-component/release/leapmmw_sensor.h) file into your esphome configuration directory
 * Include the following in the YAML configuration for your ESP board:
   ...
   packages:
     remote_package:
       url: https://github.com/Presswerk65/esphome-hs2xx3a-custom-component
       ref: release
